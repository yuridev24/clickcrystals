        ...
        <div className="py-1">
          {links.map((link, index) => (
            <>
              ...
              <a href={link.url} key={index} className="transition-all duration-75 block px-4 py-2 mt-0 mb-0 h-full w-full text-sm text-gray-700 hover:text-blue-500 hover:bg-gray-200">{link.label}</a>
            </>
          ))}
        </div>
      </div>
